...
**RPA Recorder (Dynamic)** (`ai.rever.boss.plugin.dynamic.rparecorder`) is a dynamic plugin for the BOSS desktop application.

Record browser interactions for automation

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.rparecorder`
- **Main Class**: `ai.rever.boss.plugin.dynamic.rparecorder.RparecorderDynamicPlugin`
- **API Version**: 1.0.20
